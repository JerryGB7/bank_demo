...
def demo_seed_data() -> None:
    ...
    Technician(10, "Operation-Manager")
    Technician(11, "Field-Technician")
    Technician(20, "Operation-Manager")
    Technician(21, "Field-Technician")
    Technician(30, "Operation-Manager")
    Technician(31, "Field-Technician")
    Technician(40, "Operation-Manager")
    Technician(41, "Field-Technician")
    Technician(999, "Auditor")
